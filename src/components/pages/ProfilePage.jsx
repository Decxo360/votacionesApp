...
export const ProfilePage = () => {
  ...
  const handleChange = () => {
    isActive == 'none' ? setActive('hidden') : setActive('none')
  }
          ...
          <div className='bg-white w-[50%] h-auto pb-[30px] rounded-2xl flex flex-col'>
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              <form className='flex flex-col mt-10 w-[100%] items-center justify-center gap-3'>
                ...
                <input className='w-[60%] h-[40px] text-center rounded-2xl border' type="text" placeholder='Aqui va el nombre de la votacion que quieres crear'/>
              </form>
            </div>
